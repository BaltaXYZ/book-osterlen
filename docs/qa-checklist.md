...
## Slutleverans
- [x] Samtliga kapitel finns som separata `.md`.
- [x] Sammanställt manus finns.
- [x] PDF finns.
- [x] Formgiven bok-PDF med omslag och baksida finns.
- [x] Manusets verifierade omfång är minst 75 000 ord.
- [x] Dialogen har fått särskild naturlighetsgranskning och riktad revision.
- [x] Blockerarlistan är genomgången.

## Residual risk
- Ingen blockerande residual risk återstår mot den definierade slutleveransen.
