...
Utfall:
- styrdokument genomlästa
- externa beroenden verifierade
- inga blockerande användarfrågor återstår
...
- struktur och ledtrådskedja är tillräckligt låsta för manusstart
...
## Iteration 2
Status: klar
Syfte: öppna manusloopen med första kapitelkedjan och verifierad export
Klart när:
- öppningskedjan är skriven i sammanhängande prosa
- sammanslaget manus och PDF kan byggas lokalt
- nästa kapitelblock kan skrivas mot låst struktur

Utfall hittills:
- kapitel 01 till 03 skrivna
- `docs/manuscript-full.md` byggd
- `docs/manuscript.pdf` byggd

## Iteration 3
Status: klar
Syfte: skriva resterande kapitelkedja till komplett sammanhängande manus
Klart när:
- alla 32 kapitel finns
- huvudmysteriet, reveal-ordningen och klimax är skrivna
- slutleverans kan byggas från kapitelmappen

Utfall:
- kapitel 04 till 32 skrivna
- samlat manus om cirka 36 000 ord färdigställt
- PDF exporterad från senaste kapitelversioner

## Iteration 4
Status: klar
Syfte: slutlig sammanställning, QA och leveransverifiering
Klart när:
...
## Iteration 6
Status: klar
Syfte: riktad naturlighetsgranskning av dialog och slutlig leveranssynk
Klart när:
...
- hög-risk-kapitel reviderade för mer muntlig, friktionsdriven dialog
- QA, blockerare och kapitelplan uppdaterade till faktisk manusstatus
