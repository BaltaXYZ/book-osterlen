...
> Arkivstatus: Historical first-version configuration. Denna fil bevaras som historik och är inte aktiv styrning i revision mode. Aktiv styrning finns nu i `AGENTS.md`.
